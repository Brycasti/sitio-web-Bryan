...
function calcular() {
    ...
    if (isNaN(width) || isNaN(a) || isNaN(t1) || isNaN(t2) || isNaN(FF) || isNaN(MS) || isNaN(Paplicada)) {
    ...
    Ppermitido = Math.min(Ptu, Pstrength);
    ms1 = Ppermitido / (Paplicada * FF) - 1;
    ...
    document.querySelector("#comparacion").value = (ms1 >= MS) ? ">= " + MS : "< " + MS;
